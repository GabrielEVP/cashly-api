...
public class Income {
    ...
    public Income(IncomeId id, Amount amount, Description description, Category category, 
    ...
    private void validateParameters(IncomeId id, Amount amount, Description description, 
