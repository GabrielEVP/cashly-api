...
class DescriptionUnitTest {
    ...
    void should_CreateDescription_When_ValidValueProvided() {
        // Arrange
        String validDescription = "Grocery shopping";
    ...
    void should_TrimWhitespace_When_ValueHasLeadingTrailingSpaces() {
        // Arrange
        String descriptionWithSpaces = "  Grocery shopping  ";
        String expectedTrimmed = "Grocery shopping";
    ...
    void should_NotBeEqual_When_DifferentDescriptionValues() {
        // Arrange
        Description description1 = new Description("Grocery shopping");
        Description description2 = new Description("Gas station");
    ...
    void should_ReturnTrue_When_ContainsKeyword() {
        // Arrange
        Description description = new Description("Weekly grocery shopping");
        
        // Act & Assert
        assertTrue(description.contains("grocery"));
        assertTrue(description.contains("GROCERY")); // Case insensitive
